...
<div id="container">
    <div id="header">
  <div class="div1">
    <div class="div2" style="font-size:16pt;" onclick="location = '<?php echo $home; ?>'"><b><?php echo $heading_title; ?></b></div>
    <?php if ($logged) { ?>
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
	  ...
	  <li id="fbpixel"><a class="top" href="<?php echo $fbpixel; ?>" style='background:none;color:#3961A8;font-weight:bold;'>Facebook Pixel</a>
    </ul>
