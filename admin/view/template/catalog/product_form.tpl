            ...
            <table class="form">
              ...
              <tr>
                ...
                <tr>
                    ...
                    <td><textarea name="product_description[<?php echo $language['language_id']; ?>][meta_description]" cols="40" rows="3"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_description'] : ''; ?></textarea></td>
                </tr>
                <tr>
                    <td><?php echo $entry_meta_keyword; ?></td>
                    <td><textarea name="product_description[<?php echo $language['language_id']; ?>][meta_keyword]" cols="40" rows="2"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea></td>
                </tr>
              <tr>
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="hidden" name="upc" value="<?php echo $upc; ?>" />
              <input type="hidden" name="sku" value="<?php echo $sku; ?>" />
              <input type="text" name="ean" value="<?php echo $ean; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_jan; ?></td>
              <td><input type="text" name="jan" cols="30" value="<?php echo $jan; ?>" ></input></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="price" value="<?php echo $price; ?>" />
                    <input type="hidden" name="location" value="<?php echo $location; ?>" /></td>
            </tr>
