          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="welcome_module[<?php echo $module_row; ?>][position]">
                  <?php if ($module['position'] == 'header_hotline') { ?>
                  <option value="header_hotline" selected="selected"><?php echo $text_header_hotline; ?></option>
                  <?php } else { ?>
                  <option value="header_hotline"><?php echo $text_header_hotline; ?></option>
                  <?php } ?>
                  <?php if ($module['position'] == 'support_hotline') { ?>
                  <option value="support_hotline" selected="selected"><?php echo $text_support_hotline; ?></option>
                  <?php } else { ?>
                  <option value="support_hotline"><?php echo $text_support_hotline; ?></option>
                  <?php } ?>
                  <?php if ($module['position'] == 'free_ship') { ?>
                  <option value="free_ship" selected="selected"><?php echo $text_free_ship; ?></option>
                  <?php } else { ?>
                  <option value="free_ship"><?php echo $text_free_ship; ?></option>
                  <?php } ?>
...
function addModule() {	
	...
	html += '        <option value="header_hotline"><?php echo $text_header_hotline; ?></option>';
	html += '        <option value="support_hotline"><?php echo $text_support_hotline; ?></option>';
	html += '        <option value="free_ship"><?php echo $text_free_ship; ?></option>';
