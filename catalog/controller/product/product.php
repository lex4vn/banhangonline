...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
            ...
            $this->data['text_price_market'] = $this->language->get('text_price_market');
            ...
            $this->data['text_code_buy'] = $this->language->get('text_code_buy');
            ...
            $this->data['material'] = $product_info['jan'];
            $this->data['size'] = $product_info['ean'];
            $this->data['warranty'] = $product_info['isbn'];
            $this->data['supplier'] = $product_info['mpn'];
            $this->data['date_modified'] = date("d/m/Y");
            ...
            $this->data['cart_payment'] =  $this->url->link('checkout/cart');
