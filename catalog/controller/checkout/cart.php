...
class ControllerCheckoutCart extends Controller {
	...
	public function index() {
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
            ...
            $this->data['button_payment_guest'] = $this->language->get('button_payment_guest');
			...
			$this->data['action_confirm'] = $this->url->link('checkout/confirm');
			...
			} elseif (isset($this->session->data['fullname'])) {
            ...
            } elseif (isset($this->session->data['address_1'])) {
            ...
            } elseif (isset($this->session->data['address_2'])) {
                $this->data['address_2'] = $this->session->data['address_2'];
            } else {
                $this->data['address_2'] = '';
            }
			// Totals
