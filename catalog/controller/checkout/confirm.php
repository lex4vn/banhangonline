...
class ControllerCheckoutConfirm extends Controller { 
	public function index() {
        ...
        $this->session->data['guest']['lastname'] = $this->request->post['firstname'];
        $this->session->data['guest']['email'] = $this->request->post['email'];
        $this->session->data['guest']['telephone'] = $this->request->post['telephone'];

        $this->session->data['guest']['payment']['firstname'] = $this->request->post['firstname'];
        $this->session->data['guest']['payment']['lastname'] = $this->request->post['firstname'];
        $this->session->data['guest']['payment']['company'] = "Guest";
        $this->session->data['guest']['payment']['company_id'] = "1";
        ...
        $this->session->data['guest']['payment']['postcode'] = "0084";
        ...
        $this->session->data['guest']['shipping']['lastname'] = $this->request->post['firstname'];
		...
		if (!$redirect) {
			...
			$data['comment'] = $this->session->data['guest']['payment']['address_2'];
			$data['total'] = $total;
