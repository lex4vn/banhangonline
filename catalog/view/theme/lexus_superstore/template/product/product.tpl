		...
		<div class="product-info">
			<div class="row">			
				...
				<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 product-view">
					...
					<div class="review">
						<div>
                            <?php echo $text_code_buy; ?>&nbsp;<span><?php echo $model; ?></span>&nbsp;
                            <?php echo $text_view; ?>&nbsp;<span><?php echo $viewed; ?></span>&nbsp;
                            <?php echo $text_updated; ?>&nbsp;<span><?php echo $date_modified; ?></span>&nbsp;
					...
					<div class="price">
						<div class="price-gruop">
                            ...
                            <br/>
                            <label><?php echo $text_price_market; ?></label>
					...
					<div class="product-extra">
						...
						<div class="cart pull-left">					
							<!-- <input type="button" value="<?php //echo $button_cart; ?>" id="button-cart" class="button btn btn-theme-default" /> -->
                                <button id="btnPayment" class="btn btn-theme-default button-payment"">
                                    <span><?php echo $button_payment; ?></span>
								</button>
						</div>
						<div class="action pull-left">
							<div class="pull-left">

								<button id="button-cart" class="btn btn-shopping-cart button-cart">
								<span><?php echo $text_add_to_cart; ?></span>
							</button> 
							</div>
						</div>
			...
			<?php } ?>  
                ...
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 free-ship">
                    <?php echo $free_ship; ?>
                </div>
        </div>
</div>
...
<div class="tabs-group box row-fuild">
	...
	<div id="tab-description"><?php echo $description; ?>
	        <div class="row">
            <div class="center">
                <button class="btn btn-theme-default button-payment"">
                <span><?php echo $button_payment; ?></span>
                </button>
                <button class="btn btn-shopping-cart button-cart">
                    <span><?php echo $text_add_to_cart; ?></span>
                </button>
