...
<div class="buttons">
  <table>
    <tr>
      <td align="left"></td>
      <td align="right"><a href="<?php echo $confirm; ?>" class="button btn btn-theme-default"><?php echo $button_confirm; ?></a></td>
    </tr>
  </table>
</div>
...
<div class="buttons">
  <table>
    <tr>
      <td align="left"><a href="<?php echo $back; ?>" class="button btn btn-theme-default"><?php echo $button_back; ?></a></td>
      <td align="right"></td>
    </tr>
  </table>
</div>
