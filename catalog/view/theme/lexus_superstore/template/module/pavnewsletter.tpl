	...
	<div class="box-content">
		<form id="formNewLestter" method="post" action="<?php echo $action; ?>" class="formNewLestter">
			<div class="box-heading pull-left">
				...
				<div>
					<p class="title_newletter"><?php echo $this->language->get("entry_newsletter");?></p>
			...
			<div class="clearfix input-group">
				...
				<input type="submit" name="submitNewsletter" class="button_mini btn" value="<?php echo $this->language->get("button_subscribe");?>">		
